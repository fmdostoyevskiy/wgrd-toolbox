...
import { SPEC_VET_BONUS } from '../constants/specs.js';
import { V2Card } from '../card/V2Card.jsx';

// Shift avail array right by `shift` positions, clamping overflow to Elite
// (index 4). Collisions at Elite take the max, not the sum.
