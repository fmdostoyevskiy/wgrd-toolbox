...
import { FlagImg } from '../shared/FlagImg.jsx';
...
// Render a single unit row, plus a slide-out for transports when open. The
// row's own click target selects the unit; the chevron toggles transports;
// each transport row selects its own unit.
